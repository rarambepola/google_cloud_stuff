...
tryCatch(dyn.unload(dynlib("gp_rff_t")),
         error = function(e) print(e))
compile("gp_rff_t.cpp")
dyn.load(dynlib("gp_rff_t"))
...
save(list=c("fit"),
     file=paste0(path_output, "/gp_rff_t_fit.RData"))

save(list=c("rep"),
     file=paste0(path_output, "/gp_rff_t_rep.RData"))

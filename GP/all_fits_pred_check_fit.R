...
# # 
load("all_covs_mesh_fit_fixed_hypers_full.RData")


source("model_pred_functions2_checK_fit.R")
...
save(pred_list, 
     file = paste0(path_output, "/all_covs_mesh_check_fit.RData"))
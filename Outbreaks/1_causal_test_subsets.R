...
load("causal_subsets_to_test.RData")
...
# for(time_iter in 1:2){
  causal_subsets <- causal_subsets_to_test[[time_iter]]
  ...
  causal_loss[[time_iter]] <- iter_loss

  save(list = c("causal_loss",
                "mesh",
                "spde",
                "A_fit",
                "A_pred"),
       file = paste0(path_output, "/causal_subset_test_fits_iter_", time_iter, ".RData"))
}
...
#               "A_fit",
#               "A_pred"),
#      file = "causal_subset_test_fits.RData")
